...
class _FamilyGuardianScreenState extends State<FamilyGuardianScreen> with SingleTickerProviderStateMixin {
  ...
  void _generateToken() {
    setState(() {
      _guardian.generateTemporalToken(); // Genera el token internamente en el manager
      _secondsLeft = 60;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(isEs ? 'Red de Acompañamiento Seguro' : 'Trusted Care Network'),
        bottom: TabBar(
          controller: _tabs,
      ...
      child: Column(children: [
        ...
        BioSenseTheme.clinicalCard(
          ...
          child: Column(
            ...
            children: [
              Row(children: [
                const Icon(Icons.shield_outlined, color: BioSenseColor.primary, size: 20),
              ...
              Text(
                  isEs ? 'Comparta este código únicamente con personas de su confianza. Solo verán su estado general (Estable / Vigilancia / Alerta). Nunca datos médicos detallados.' : 'Share this code only with trusted individuals. They will only see your general status (Stable / Watch / Alert). Never detailed medical data.',
          ...
          child: Column(children: [
            QrImageView(
              ...
              eyeStyle: const QrEyeStyle(
                  eyeShape: QrEyeShape.square, color: BioSenseColor.primary),
              dataModuleStyle: const QrDataModuleStyle(
                  dataModuleShape: QrDataModuleShape.square, color: BioSenseColor.textPrimary),
            ),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(
                  isEs ? 'Código válido por $_secondsLeft segundos' : 'Code valid for $_secondsLeft seconds',
        ...
        BioSenseTheme.clinicalCard(
          ...
          child: Row(children: [
            const Icon(Icons.lock_outline, color: BioSenseColor.stable, size: 20),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                  isEs ? 'Este código expira automáticamente en 60 segundos. Una fotografía del código QR no puede ser reutilizada después de su expiración. Privacidad de grado financiero.' : 'This code expires automatically in 60 seconds. A photograph of the QR code cannot be reused after expiration. Financial-grade privacy.',
      ...
      Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(isEs ? 'Vincular nuevo contacto (QR)' : 'Link new contact (QR)'),
          ),
        ),
      ),
        ...
        child: familiars.isEmpty
            ? Center(
                child: Column(
                    ...
                    children: [
                    const Icon(Icons.people_outline, size: 48, color: BioSenseColor.textMuted),
                    const SizedBox(height: 16),
                    Text(
                        isEs ? 'Sin contactos vinculados.\nComparta su código QR para iniciar.' : 'No contacts linked.\nShare your QR code to start.',
            ...
            : ListView.separated(
                ...
                separatorBuilder: (_, __) => const SizedBox(height: BioSenseSpacing.md),
                itemBuilder: (_, i) => BioSenseTheme.clinicalCard(
                  ...
                  child: Row(children: [
                    ...
                    IconButton(
                        icon: const Icon(Icons.call_outlined, color: BioSenseColor.stable, size: 24),
                        onPressed: () {},
